...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_heads', type=int, default=8, help='attention heads nums')
    ...
    parser.add_argument('--data_path', type=str, default='unify_data/data_new', help='the number of categories to the last label')
    parser.add_argument('--label_path', type=str, default='/home/a41/fedAes/unify_data/data_new/label.xlsx', help='the number of categories to the last label')
    parser.add_argument('--embedding_dim', type=int, default=200, help='the number of categories to the last label')
    parser.add_argument('--FocalLoss_alpha', type=float, default=0.25, help='the number of categories to the last label')
    parser.add_argument('--FocalLoss_gamma', type=float, default=3, help='the number of categories to the last label')
    parser.add_argument('--log_config_path', type=str, default='LogConfig.ini', help='the number of categories to the last label')
    parser.add_argument('--log_level', type=str, default='DEBUG', help='the number of categories to the last label')
    parser.add_argument('--res_save_path', type=str, default='result', help='the number of categories to the last label')
    parser.add_argument('--expand_name', type=str, default=str('debug'), help='the number of categories to the last label')
    parser.add_argument('--SEED', type=int, default=0, help='the number of categories to the last label')
    ...
    for fold, (train_loader, test_loader) in enumerate(folds):
        ...
        for epoch in range(opt.epochs):
            model.train(train_loader, optimizer, epoch, param_to_name)
