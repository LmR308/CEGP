...
if __name__ == '__main__':
    ...
    parser.add_argument('--dim_nums', type=int, default=77, help='the number of aesthetic perception dimensions')
    ...
    parser.add_argument('--FocalLoss_alpha', type=float, default=1, help='the value of the alpha parameter in FocalLoss')
    parser.add_argument('--FocalLoss_gamma', type=float, default=2, help='the value of the gamma parameter in FocalLoss')
